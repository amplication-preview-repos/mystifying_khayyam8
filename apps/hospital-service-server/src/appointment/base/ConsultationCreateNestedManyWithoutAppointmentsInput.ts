...
@InputType()
class ConsultationCreateNestedManyWithoutAppointmentsInput {
...
export { ConsultationCreateNestedManyWithoutAppointmentsInput as ConsultationCreateNestedManyWithoutAppointmentsInput };
